      ...
      for (let i = 0; i < 7; i++) {
        ...
        days.push(
          <div
            ...
            className={`relative p-2 rounded cursor-pointer border-2 border-[#111] text-center min-h-[4rem] sm:min-h-[5rem] lg:min-h-[6rem] transition-all duration-150
...
return (
  <div className="flex flex-col lg:flex-row gap-8 p-4 sm:p-6 text-white bg-black rounded-lg shadow-lg max-w-7xl mx-auto lg:h-[70vh]">
    ...
    <div className="w-full lg:w-1/3 pr-2 overflow-y-auto max-h-[50vh] lg:max-h-[70vh] lg:overflow-y-auto">
